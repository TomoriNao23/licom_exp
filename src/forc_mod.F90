...
!     Forcing Fields
!     ------------------------------------------------------------------
      real(r8),dimension(imt,jmt,12)::su3,sv3,psa3,tsa3,qar3,uva3, &
                    swv3,cld3,sss3,sst3&
!lhl
                    ,nswv3,dqdt3,chloro3&
!lhl
...
!#if (defined WAVEFORCE)
       real(r8),dimension(imt,jmt,km,12)::tbv3 !wave
!#endif
!linpf
...
!linpf
!#if (defined WAVEFORCE)
       real(r8),dimension(imt,jmt,km)::tbv !wave
!#endif
!linpf
...
!
!#ifdef SPMD
      real(r8),dimension(imt,jmt_global,12)::su3_io,sv3_io,psa3_io,tsa3_io,qar3_io,uva3_io, &
...
!linpf
!#if (defined WAVEFORCE)
       real(r8),dimension(imt,jmt_global,km,12)::tbv3_io !wave
!#endf
!linpf                   
                                                        
#if (defined FRC_DAILY)
      real(r8),dimension(imt,jmt_global)::su_in_io,sv_in_io
      real(r8),dimension(imt,jmt_global)::su_io,sv_io
#endif
!lhl
!#endif
!
