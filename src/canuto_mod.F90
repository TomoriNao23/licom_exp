...
!981215 \pi value
      PARAMETER(pi_const=3.14159265358979312D0)
!*****CD
...
!	cover the unrealizable region.
      PARAMETER(n_theta_r_oct=INT(((pi_const/4.D0)*mt_ra_r)/15.D0)*15)
...
!	\phi_0 = 6 \times 10^{-5} s^{-2} (2 pi/100)^{-1} cm
      PARAMETER(back_ph_0=(6.D-5)*(1.D2/(2.D0*pi_const)))	
