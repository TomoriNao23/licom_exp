...
!      real(r8),dimension(imt,jmt,km)::ALPHA1,BETA1
...
#ifdef SPMD
      call exchange_3d(DLU,km)
      call exchange_3d(DLV,km)
#endif
...
!
!$OMP PARALLEL DO PRIVATE (K,J,I,TUP,SUP,TLO,SLO,RHOUP,RHOLO)
      DO K = 1,KMM1
...
!$OMP PARALLEL DO PRIVATE (J,I,K,ABCD)
      DO K = 1,KM
        DO J = JST,JET
         DO I = 1,IMT
